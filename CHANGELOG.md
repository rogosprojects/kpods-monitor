...
### Added
- Added configuration option to fully disable metrics collection while keeping pod status watching enabled
- Added UI enhancement to hide CPU and memory columns when metrics collection is disabled
